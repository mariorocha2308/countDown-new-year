...
function App() {
  ...
  return (
    <main>
      <section className='hidden xl:block select-none' id='container'>
      ...
      <section className='w-full h-screen bg-slate-900 xl:hidden flex justify-center items-center text-white p-10'>
